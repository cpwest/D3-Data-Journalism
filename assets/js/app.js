...
// set the radius for each dot on graph
var circRadius;
function crGet() {
  if (width <= 530) {
    circRadius = 5;
...
// xText appends three text SVG files with y coordinates specified to space out the values
// Poverty
xText
  .append("text")
  .attr("y", -26)
 ...
 var xMin;
  ...
  var toolTip = d3
    ...
    .html(function(d) {
      ...
      if (curX === "poverty") {
        // grab the x key and format the value to show percentage
        theX = "<div>" + curX + ": " + d[curX] + "%</div>";
      }
      else {
     
        // grab the x key and a version of the value formatted to include commas
        theX = "<div>" +
          curX +
          ": " +
  ...
  // add the initial placement of our data and axes to the scatter plot
...
// return the abbreviation to .text
  ...
  // make graph interative 
  // have data displayed change as user clicks on different labels
